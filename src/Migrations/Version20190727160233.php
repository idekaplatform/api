...
final class Version20190727160233 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE project__candidatures ADD CONSTRAINT FK_C1F3FF8F3481D195 FOREIGN KEY (job_offer_id) REFERENCES project__job_offers (id)');
        $this->addSql('ALTER TABLE project__candidatures ADD CONSTRAINT FK_C1F3FF8FA76ED395 FOREIGN KEY (user_id) REFERENCES user__users (id)');
    }
